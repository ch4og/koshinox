...
(define-public %koshi-chs
  (list (channel
        ...
        (channel
         ...
         (branch "main")
         (commit
          "56c7054ea05047eb87fac09123a6c629d6e08916")
         (introduction
          (make-channel-introduction
        ...
        (channel
         ...
         (branch "main")
         (commit
          "4efb8c5e06debc3a32a711e3508593cfd1e1fb48"))
        (channel
         (name 'quickshell)
        ...
        (channel
         ...
         (branch "main")
         (commit
          "2f4c4a9bb2e1d1dc2944bffbb2b63ee04405c1e8")
         (introduction
          (make-channel-introduction
        ...
        (channel
         ...
         (branch "master")
         (commit
          "c2700f2c0be0fc93a59b244662a3bf18b94a6f98")
         (introduction
          (make-channel-introduction
